...
export interface ApiKtWebExperienceKtWebExperience
  extends Struct.SingleTypeSchema {
  collectionName: 'kt_web_experiences';
  info: {
    displayName: 'kt-web-experience';
    pluralName: 'kt-web-experiences';
    singularName: 'kt-web-experience';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::kt-web-experience.kt-web-experience'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiKtWebExpoKtWebExpo extends Struct.SingleTypeSchema {
  collectionName: 'kt_web_expos';
  info: {
    displayName: 'kt-web-expo';
    pluralName: 'kt-web-expos';
    singularName: 'kt-web-expo';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ExpoEventDateEnd: Schema.Attribute.String;
...
export interface ApiKtWebHeaderKtWebHeader extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'kt-web-header';
    pluralName: 'kt-web-headers';
    singularName: 'kt-web-header';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    HeaderEventExpoDate: Schema.Attribute.String;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::kt-web-header.kt-web-header'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiKtWebRecapKtWebRecap extends Struct.SingleTypeSchema {
  collectionName: 'kt_web_recaps';
  info: {
    displayName: 'kt-web-recap';
    pluralName: 'kt-web-recaps';
    singularName: 'kt-web-recap';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::kt-web-recap.kt-web-recap'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    RecapBrowseSuppliersLabel: Schema.Attribute.String;
    RecapPastEvents: Schema.Attribute.JSON;
    RecapTitle: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
